      ...
      <v-row class="flex-column flex-lg-row mx-auto">
        <v-col class="col-12 col-lg-10 order-last order-lg-first">
          <div class="d-flex flex-column">
            ...
            >Specialized on Frontend technologies with 4 years of experience building performant end-to-end applications. As an enthusiast for progress my goal is to create innovative websites and applications that could make a positive impact in society and solve real world problems.</p>
